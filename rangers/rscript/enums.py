...
VAR_TYPE_DECOMPILATION = {
    VAR_TYPE.UNKNOWN: VAR_TYPE_S.UNKNOWN,
    VAR_TYPE.INTEGER: VAR_TYPE_S.INTEGER,
    VAR_TYPE.DWORD:   VAR_TYPE_S.DWORD,
    VAR_TYPE.STRING:  VAR_TYPE_S.STRING,
    VAR_TYPE.FLOAT:   VAR_TYPE_S.FLOAT,
    VAR_TYPE.ARRAY:   VAR_TYPE_S.ARRAY,
}

VAR_TYPE_COMPILATION = {
    VAR_TYPE_S.UNKNOWN: VAR_TYPE.UNKNOWN,
    VAR_TYPE_S.INTEGER: VAR_TYPE.INTEGER,
    VAR_TYPE_S.DWORD:   VAR_TYPE.DWORD,
    VAR_TYPE_S.STRING:  VAR_TYPE.STRING,
    VAR_TYPE_S.FLOAT:   VAR_TYPE.FLOAT,
    VAR_TYPE_S.ARRAY:   VAR_TYPE.ARRAY,
}
